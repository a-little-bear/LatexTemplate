...
\noindent
The DocumentClass \textit{alittlebear.cls} aims to provide a simple and easy template for writing math notes on latex. The link to alittlebear.cls can be found at \url{https://github.com/a-little-bear/Latex-Template}.\\
...
\verb=\RequirePackage[margin=0.5in]{geometry}=
\explain{Margin, Default: 0.5in, may change to 1in}
